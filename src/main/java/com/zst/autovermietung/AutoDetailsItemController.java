...
public class AutoDetailsItemController implements Initializable {
    ...
    @FXML
    private Button editAuto;

    @FXML
    private Button removeAuto;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        if(DBautovermietung.getThisBenutzer().getRolle().equals("Mitarbeiter")) {
            removeAuto.setVisible(false);
            editAuto.setVisible(false);
        }
    }
